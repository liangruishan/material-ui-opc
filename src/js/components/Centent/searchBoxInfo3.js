...
var SearchBox3 = React.createClass({
...
render() { 
    ...
    return (
    	<div>
			...
			<TextField hintText="门店编码" underlineFocusStyle={{borderColor:'#c1c8de'}} style={Textfield} />
...
<form id="">
        ...
        <div className="sits"><label>门店名称</label><input type="text" value="" className="form-control w1"></input></div>
        <div className="sits"><label>门店编码</label><input type="text" value="" className="form-control w1"></input></div>
        <div className="sits">
